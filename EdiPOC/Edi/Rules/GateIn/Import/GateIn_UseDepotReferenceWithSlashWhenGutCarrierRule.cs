...
/// </summary>
internal sealed class GateIn_UseDepotReferenceWithSlashWhenGutCarrierRule : EdiRule
{
    public override string Name => nameof(GateIn_UseDepotReferenceWithSlashWhenGutCarrierRule);
    ...
    {
        edi.SetGateInReference(transport.OrderDetails.References.DepotReference!.Split(SplitCharacter)[0]);
