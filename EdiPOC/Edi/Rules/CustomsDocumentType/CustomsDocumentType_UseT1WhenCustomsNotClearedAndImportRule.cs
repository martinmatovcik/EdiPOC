...
internal sealed class CustomsDocumentType_UseT1WhenCustomsNotClearedAndImportRule : EdiRule
{
    public override string Name => nameof(CustomsDocumentType_UseT1WhenCustomsNotClearedAndImportRule);
    public override int Priority => 10;
    private const string NotCustomsClearedText = "T1";
    ...
    {
        edi.SetCustomsDocumentType(NotCustomsClearedText);
